  ...
  if(PELEC_ENABLE_CPPCHECK)
    ...
    if(CPPCHECK_EXE)
      ...
      add_custom_target(cppcheck
          ...
          COMMAND cat cppcheck/cppcheck-short-report.txt | egrep "information:|error:|performance:|portability:|style:|warning:" | sort | awk "BEGIN{i=0}{print $0}{i++}END{print 'Warnings: 'i}" > cppcheck-warnings.txt
