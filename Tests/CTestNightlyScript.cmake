...
if(result GREATER -1)
  ...
  if(result EQUAL 0)
    ...
    if(RUN_CODE_ANALYSIS)
      message("\n -- Code analysis - ${CTEST_BUILD_NAME} --")
      set(CTEST_NOTES_FILES ${CTEST_NOTES_FILES} "cppcheck-warnings.txt")
      ctest_build(BUILD "${CTEST_BINARY_DIRECTORY}" TARGET cppcheck RETURN_VALUE result)
      message(" -- Code analysis exit code = ${result} --")
    endif()
