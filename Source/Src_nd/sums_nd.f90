...
contains
  ...
  end subroutine pc_sumsquared

  

  subroutine pc_sumlocmass(lo,hi,rho,r_lo,r_hi,dx,&
  ...
  end subroutine pc_sumlocmass



  subroutine pc_sumlocmass2d(lo,hi,rho,r_lo,r_hi,dx,&
  ...
  end subroutine pc_sumlocmass2d



  subroutine pc_sumlocsquaredmass(lo,hi,rho,r_lo,r_hi,dx,&
  ...
  end subroutine pc_sumlocsquaredmass
  ...
  end subroutine pc_sumproduct

end module pelec_sums_module
