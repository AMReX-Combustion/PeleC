...
contains
 ...
 subroutine pc_hypfill2(adv,adv_lo,adv_hi,domlo,domhi,delta,xlo,time,bc) &
       bind(C, name="pc_hypfill2")
...
write(*,*) ''
write(*,*) 'HEY IT WORKS'
write(*,*) 'HEY adv ',lbound(adv),ubound(adv)
write(*,*) 'HEY adv lo ',adv_lo
write(*,*) 'HEY adv hi ',adv_hi
write(*,*) 'HEY delta ',delta
write(*,*) 'HEY xlo ',xlo
write(*,*) 'HEY time ',time
write(*,*) 'HEY bc ',bc(1,1,1)

  end subroutine pc_hypfill2
