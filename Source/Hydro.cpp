...
#pragma omp parallel if (amrex::Gpu::notInLaunchRegion())               \
    ...
    reduction(+:AMREX_D_DECL(xmom_added_flux,ymom_added_flux,zmom_added_flux))	\
    reduction(+:mass_lost,AMREX_D_DECL(xmom_lost,ymom_lost,zmom_lost))		\
    reduction(+:eden_lost,AMREX_D_DECL(xang_lost,yang_lost,zang_lost)) 		\
