  ...
  const amrex::Geometry& geom, const int required_level, const int max_level)
{
  ...
  else if (geom_type == "ICE_PistonBowl")
  {
        ...
        amrex::EB2::CylinderIF cf2(0.04, 0.125, 0, {-0.0125-0.02,0.0,0.0}, false);
        amrex::EB2::CylinderIF cf3(0.03, 0.125, 0, {-0.0125-0.02,0.0,0.0}, false);
        auto pipe = amrex::EB2::makeDifference(cf2,cf3);
        amrex::EB2::CylinderIF cf4(0.03, 0.10, 0, {-0.0125-0.02,0.0,0.0}, false);
