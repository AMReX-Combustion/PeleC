...
{  amrex::ParmParse pp("prob");
  ...
  for (int idir = 0; idir < AMREX_SPACEDIM; idir++) {
    PeleC::prob_parm_device->split[idir] = PeleC::prob_parm_device->frac * (problo[idir] + probhi[idir]);
  }
  ...
  if (PeleC::prob_parm_device->use_Tinit) {
    EOS::RTY2P(PeleC::prob_parm_device->rho_l, PeleC::prob_parm_device->T_l, massfrac, PeleC::prob_parm_device->p_l);
    ...
    EOS::RTY2P(PeleC::prob_parm_device->rho_r, PeleC::prob_parm_device->T_r, massfrac, PeleC::prob_parm_device->p_r);
    EOS::RYP2E(PeleC::prob_parm_device->rho_r, massfrac, PeleC::prob_parm_device->p_r, e_r);
