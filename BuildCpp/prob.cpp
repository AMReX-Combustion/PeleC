...
AMREX_GPU_DEVICE_MANAGED int pmf_N = 0;
AMREX_GPU_DEVICE_MANAGED int pmf_M = 0;
...
amrex::Gpu::ManagedVector<amrex::Real> fuel_state;

AMREX_GPU_DEVICE_MANAGED amrex::Real* d_pmf_X = NULL;
AMREX_GPU_DEVICE_MANAGED amrex::Real* d_pmf_Y = NULL;
AMREX_GPU_DEVICE_MANAGED amrex::Real* d_fuel_state = NULL;
